  ...
  if (date("Y-m-d", $appdate1) >= $cur_date) {
    if ((date("Y-m-d", $appdate1) == $cur_date and date("H:i:s", $apptime1) > $cur_time) or date("Y-m-d", $appdate1) > $cur_date) {
      ...
      if (mysqli_num_rows($check_query) == 0) {
        $query = mysqli_query($con, "insert into appointmenttb(pid,doctor,appdate,apptime,userStatus,doctorStatus) values($pid,'$doctor','$appdate','$apptime','1','1')");
...
if (isset($_GET["generate_bill"])) {
  ...
  header('Location:bill.php?ID='. urlencode($id));

  //echo $content;
}

//get specialization of doctors for form
function get_specs()
{
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    ...
    <style>
      .bg-primary {
        ...
        background: linear-gradient(90deg, rgba(2, 0, 36, 1) 0%, rgba(121, 94, 199, 1) 0%, rgba(210, 137, 176, 1) 100%);
      }
            ...
            <div class="container-fluid container-fullw bg-white">
              <div class="row">
                <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-stethoscope fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i> </span>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-medkit fa-stack-2x text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
              ...
              <div class="col-sm-4" style="left: 20%;margin-top:5%">
                <div class="panel panel-white no-radius text-center">
                  <div class="panel-body">
                    <span class="fa-stack fa-2x"> <i class="fa fa-hospital-o fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
          ...
          <div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                $query = "select ID,doctor,docFees,appdate,apptime,userStatus,doctorStatus from appointmenttb a join doctb d on a.doctor=d.username where pid='$pid';";
                $result = mysqli_query($con, $query);
                while ($row = mysqli_fetch_array($result)) {
          ...
          <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                $query = "select a.doctor,a.ID,appdate,apptime,disease,allergy,prescription from prestb p join appointmenttb a on a.ID=p.ID where p.pid='$pid';";
