...
if (isset($_GET['prescribe'])) {
  ...
  $query = mysqli_query($con, "insert into prestb(doctor,pid,ID,disease,allergy,prescription) values ('$doctor',$pid,$ID,'$disease','$allergy','$prescription');");
  if ($query) {
          ...
          <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-home-list">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                from appointmenttb a join doctb d on a.doctor=d.username join patreg p on p.pid=a.pid where a.doctor='$dname';
                ";
          ...
          <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
            <table class="table table-hover">
              ...
              <tbody>
                ...
                from prestb p join patreg pa on pa.pid=p.pid join appointmenttb a on a.ID=p.ID where p.doctor='$doctor' ;
                ";
